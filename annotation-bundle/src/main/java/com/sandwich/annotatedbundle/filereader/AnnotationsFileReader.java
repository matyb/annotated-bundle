...
public class AnnotationsFileReader extends FileReader {
	...
	public AnnotationsFileReader(ResourceBundle bundle){
		super(bundle, ANNOTATIONS_FILE_SUFFIX, true);
	}

	@Override
	PropertyCapturer createPropertyCapturer() {
		return new PropertyCapturer(){
			@Override
			public Map.Entry<String, Map<String, String>> captureProperties(String currentLine, String previousLine) {
